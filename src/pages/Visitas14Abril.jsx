...
function Visitas14Abril() {
  return (
  <div className="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay={200}>
  <img src="/assets/img/visitas/WhatsApp Image 2024-03-29 at 19.38.02 (3).jpeg" alt className="img-fluid services-img" />
